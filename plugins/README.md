...
| [gstack-workflows](./gstack-workflows/) | Lightweight gstack-inspired engineering workflows adapted for OPC | **Skills:** `gstack-investigate`, `gstack-review`, `gstack-cso`, `gstack-qa-only`, `gstack-document-release` - Investigation, review, security, QA reporting, and documentation release checks |
